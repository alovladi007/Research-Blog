          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              <Label htmlFor="email" className="flex items-center">
                <Mail className="h-4 w-4 mr-2 text-scholar-600" />
                Email Address
              </Label>
              <Input
                id="email"
            ...
            <div>
              <Label htmlFor="password" className="flex items-center">
                <Lock className="h-4 w-4 mr-2 text-scholar-600" />
                Password
              </Label>
              <Input
                id="password"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-gray-300 text-scholar-600 focus:ring-scholar-500" />
                <span className="ml-2 text-sm text-gray-600">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-scholar-600 hover:text-scholar-700">
                Forgot password?
              </Link>
            </div>
            ...
            <Alert>
              ...
              <AlertDescription>
                Only verified academic email addresses can sign in. 
                New to ScholarHub? <Link href="/auth/signup" className="text-scholar-600 hover:text-scholar-700 font-medium">Create an account</Link>
              </AlertDescription>
            </Alert>
          </form>
        </div>
